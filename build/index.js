...
var last__default = /*#__PURE__*/ _interopDefaultLegacy(last$1);
var isFunction__default = /*#__PURE__*/ _interopDefaultLegacy(isFunction$1);
var without__default = /*#__PURE__*/ _interopDefaultLegacy(without);
var isEqual__default = /*#__PURE__*/ _interopDefaultLegacy(isEqual);
var isPlainObject__default = /*#__PURE__*/ _interopDefaultLegacy(
  isPlainObject$1
);
      ...
      React__default["default"].createElement(
        ...
        menu
          ...
          : React__default["default"].createElement(
              ...
              React__default["default"].createElement(fi.FiMenu, null),
              " ",
              React__default["default"].createElement("span", null, "Menu")
            )
      )
    )
  );
...
var BasicTooltip = React.memo(function (_ref) {
  ...
  if (typeof renderContent === "function") {
    ...
    content = React__default["default"].createElement(
      "div",
      {
...
var Crosshair = React.memo(function (_ref) {
  ...
  return React__default["default"].createElement(
    ...
    null,
    xLine &&
      React__default["default"].createElement(CrosshairLine, {
        x0: xLine.x0,
        x1: xLine.x1,
        y0: xLine.y0,
        y1: xLine.y1,
...
var useTooltipHandlers = function useTooltipHandlers(container) {
  ...
  var showTooltipFromEvent = React.useCallback(
...
var mapProps_1 = createCommonjsModule(function (module, exports) {
  ...
  var mapProps = function mapProps(propsMapper) {
    return function (BaseComponent) {
      var factory = (0, React__default["default"].createFactory)(BaseComponent);
...
var extendDefaultTheme = function extendDefaultTheme(
  ...
  var theme = merge__default["default"]({}, defaultTheme, customTheme);
  fontProps.forEach(function (prop) {
    if (
      get__default["default"](theme, "".concat(prop, ".fontFamily")) ===
      undefined
    ) {
    ...
    if (
      get__default["default"](theme, "".concat(prop, ".fontSize")) === undefined
    ) {
      set__default["default"](
        theme,
        "".concat(prop, ".fontSize"),
        theme.fontSize
      );
    }
    if (
      get__default["default"](theme, "".concat(prop, ".fill")) === undefined
    ) {
      set__default["default"](theme, "".concat(prop, ".fill"), theme.textColor);
    }
  });
  return theme;
};
...
var quantizeColorScales = {
  ...
  BrBG: last__default["default"](scheme),
  PRGn: last__default["default"](scheme$1),
  PiYG: last__default["default"](scheme$2),
  PuOr: last__default["default"](scheme$3),
  RdBu: last__default["default"](scheme$4),
  RdGy: last__default["default"](scheme$5),
  RdYlBu: last__default["default"](scheme$6),
  RdYlGn: last__default["default"](scheme$7),
  spectral: last__default["default"](scheme$8),
  blues: last__default["default"](scheme$l),
  greens: last__default["default"](scheme$m),
  greys: last__default["default"](scheme$n),
  oranges: last__default["default"](scheme$q),
  purples: last__default["default"](scheme$o),
  reds: last__default["default"](scheme$p),
  BuGn: last__default["default"](scheme$9),
  BuPu: last__default["default"](scheme$a),
  GnBu: last__default["default"](scheme$b),
  OrRd: last__default["default"](scheme$c),
  PuBuGn: last__default["default"](scheme$d),
  PuBu: last__default["default"](scheme$e),
  PuRd: last__default["default"](scheme$f),
  RdPu: last__default["default"](scheme$g),
  YlGnBu: last__default["default"](scheme$h),
  YlGn: last__default["default"](scheme$i),
  YlOrBr: last__default["default"](scheme$j),
  YlOrRd: last__default["default"](scheme$k),
};
...
var colorSchemes = {
  ...
  set2: schemeSet2,
  set3: schemeSet3,
  brown_blueGreen: last__default["default"](scheme),
  purpleRed_green: last__default["default"](scheme$1),
  pink_yellowGreen: last__default["default"](scheme$2),
  purple_orange: last__default["default"](scheme$3),
  red_blue: last__default["default"](scheme$4),
  red_grey: last__default["default"](scheme$5),
  red_yellow_blue: last__default["default"](scheme$6),
  red_yellow_green: last__default["default"](scheme$7),
  spectral: last__default["default"](scheme$8),
  blues: last__default["default"](scheme$l),
  greens: last__default["default"](scheme$m),
  greys: last__default["default"](scheme$n),
  ...
  purples: last__default["default"](scheme$o),
  reds: last__default["default"](scheme$p),
  blue_green: last__default["default"](scheme$9),
  blue_purple: last__default["default"](scheme$a),
  green_blue: last__default["default"](scheme$b),
  orange_red: last__default["default"](scheme$c),
  purple_blue_green: last__default["default"](scheme$d),
  purple_blue: last__default["default"](scheme$e),
  purple_red: last__default["default"](scheme$f),
  red_purple: last__default["default"](scheme$g),
  yellow_green_blue: last__default["default"](scheme$h),
  yellow_green: last__default["default"](scheme$i),
  yellow_orange_brown: last__default["default"](scheme$j),
  yellow_orange_red: last__default["default"](scheme$k),
};
...
var areaCurvePropKeys = without__default["default"](
  curvePropKeys,
  "bundle",
  "basisClosed",
  "basisOpen",
...
var lineCurvePropKeys = without__default["default"](
  curvePropKeys,
  "bundle",
  "basisClosed",
  "basisOpen",
...
var SvgWrapper = function SvgWrapper(_ref) {
  ...
  return React__default["default"].createElement(
    ...
    React__default["default"].createElement(Defs$1, {
      defs: defs,
    }),
    React__default["default"].createElement("rect", {
      width: width,
...
var CartesianMarkersItem = function CartesianMarkersItem(_ref2) {
  ...
  if (legend) {
    ...
    legendNode = React__default["default"].createElement(
      "text",
      {
        transform: "translate("
    ...
    withPropsOnChange(
      function (props, nextProps) {
        return (
          ...
          !isEqual__default["default"](props.margin, nextProps.margin)
        );
      },
      function (props) {
...
var getLabelGenerator = function getLabelGenerator(_label, labelFormat) {
  var getRawLabel = isFunction__default["default"](_label)
    ? _label
    : function (d) {
        return get__default["default"](d, _label);
      };
  var formatter;
  if (labelFormat) {
    formatter = isFunction__default["default"](labelFormat)
      ? labelFormat
      : format$1(labelFormat);
  }
  if (formatter)
    return function (d) {
...
var isMatchingDef = function isMatchingDef(predicate, node, dataKey) {
  if (predicate === "*") {
    return true;
  } else if (isFunction__default["default"](predicate)) {
    return predicate(node);
  } else if (isPlainObject__default["default"](predicate)) {
    var data = dataKey ? get__default["default"](node, dataKey) : node;
    return isEqual__default["default"](
      pick__default["default"](data, Object.keys(predicate)),
      predicate
    );
  }
  return false;
          ...
          if (def) {
            if (patternKeys.includes(def.type)) {
              if (def.background === "inherit" || def.color === "inherit") {
                var nodeColor = get__default["default"](node, colorKey);
              ...
              if (allColors.includes("inherit")) {
                var _nodeColor = get__default["default"](node, colorKey);
                var _inheritedId = id;
...
var getScaleTicks = function getScaleTicks(scale, spec) {
  ...
  if (scale.ticks) {
    ...
    if (isNumber__default["default"](spec)) {
...
var computeGridLines = function computeGridLines(_ref2) {
  ...
  var lineCount = isNumber__default["default"](_values) ? _values : undefined;
...
var defaultTickRenderer = function defaultTickRenderer(props) {
  return React__default["default"].createElement(AxisTick$1, props);
};
...
var GridLine = function GridLine(props) {
  return React__default["default"].createElement("line", props);
};
GridLine.propTypes = {
  x1: propTypes.number.isRequired,
...
var GridLines = function GridLines(_ref) {
  ...
  var _useMotionConfig = useMotionConfig(),
    animate = _useMotionConfig.animate,
    springConfig = _useMotionConfig.springConfig;
  var lineWillEnter = React.useMemo(
    function () {
  ...
  var lineWillLeave = React.useMemo(
    function () {
...
var Grid = function Grid(_ref) {
  ...
  return React__default["default"].createElement(
    ...
    null,
    xLines &&
      React__default["default"].createElement(GridLines$1, {
        type: "x",
        lines: xLines,
      }),
    yLines &&
...
var stackAxis = function stackAxis(axis, otherType, xy, series) {
  ...
  xy[otherAxis].all.forEach(function (v) {
    var compare = isDate__default["default"](v)
      ? compareDateValues
      : compareValues;
    var stack = [];
    series.forEach(function (serie) {
      ...
      if (datum !== undefined) {
        ...
        if (value !== null) {
          var head = last__default["default"](stack);
          if (head === undefined) {
            stackValue = value;
          } else if (head !== null) {
...
var Voronoi$1 = function Voronoi(_ref) {
  ...
  var layerById = {
    bounds: React__default["default"].createElement("path", {
      key: "bounds",
      fill: "none",
  ...
  if (enableLinks === true) {
    layerById.links = React__default["default"].createElement("path", {
      key: "links",
  ...
  if (enableCells === true) {
    layerById.cells = React__default["default"].createElement("path", {
      key: "cells",
      d: voronoi.render(),
      fill: "none",
      stroke: cellLineColor,
  ...
  if (enablePoints === true) {
    layerById.points = React__default["default"].createElement("path", {
      key: "points",
      stroke: "none",
      fill: pointColor,
...
var LinePointTooltip = function LinePointTooltip(_ref) {
  ...
  return React__default["default"].createElement(BasicTooltip, {
    id: React__default["default"].createElement(
      "span",
      null,
      "x: ",
      React__default["default"].createElement(
...
var SliceTooltip = function SliceTooltip(_ref2) {
  ...
  return React__default["default"].createElement(TableTooltip, {
    rows: slice.points.map(function (point) {
      return [
        React__default["default"].createElement(Chip$1, {
          key: "chip",
          color: point.serieColor,
        }),
        point.serieId,
...
var Lines = function Lines(_ref) {
  ...
  return lines.map(function (_ref2) {
    var id = _ref2.id,
      data = _ref2.data,
      color = _ref2.color;
    return React__default["default"].createElement(LinesItem$1, {
      key: id,
      id: id,
...
var Slices = function Slices(_ref) {
  ...
  return slices.map(function (slice) {
    return React__default["default"].createElement(SlicesItem$1, {
      key: slice.id,
      slice: slice,
      axis: axis,
      debug: debug,
  ...
  if (animate !== true) {
    return React__default["default"].createElement(
      ...
      mappedPoints.map(function (point) {
        return React__default["default"].createElement(DotsItem$1, {
          key: point.id,
          x: point.x,
          y: point.y,
          datum: point.datum,
...
var Mesh$1 = function Mesh$1(_ref) {
  ...
  return React__default["default"].createElement(Mesh, {
    nodes: points,
    width: width,
    height: height,
    onMouseEnter: handleMouseEnter,
...
var Line$1 = function Line(props) {
  ...
  var layerById = {
    grid: React__default["default"].createElement(Grid$1, {
      key: "grid",
      theme: theme,
      width: innerWidth,
      height: innerHeight,
    ...
    markers: React__default["default"].createElement(CartesianMarkers$1, {
      key: "markers",
      markers: markers,
      width: innerWidth,
      height: innerHeight,
    ...
    axes: React__default["default"].createElement(Axes$1, {
      key: "axes",
      xScale: xScale,
      yScale: yScale,
      width: innerWidth,
    ...
    areas: null,
    lines: React__default["default"].createElement(Lines$1, {
      key: "lines",
      lines: series,
      lineGenerator: lineGenerator,
      lineWidth: lineWidth,
  ...
  if (enableArea) {
    layerById.areas = React__default["default"].createElement(Areas$1, {
      key: "areas",
      areaGenerator: areaGenerator,
  ...
  if (isInteractive && enableSlices !== false) {
    layerById.slices = React__default["default"].createElement(Slices$1, {
      key: "slices",
      slices: slices,
      axis: enableSlices,
      debug: debugSlices,
  ...
  if (enablePoints) {
    layerById.points = React__default["default"].createElement(Points$1, {
      key: "points",
      points: points,
      symbol: pointSymbol,
      size: pointSize,
  ...
  if (isInteractive && enableCrosshair) {
    if (currentPoint !== null) {
      layerById.crosshair = React__default["default"].createElement(Crosshair, {
        key: "crosshair",
        width: innerWidth,
        height: innerHeight,
        x: currentPoint.x,
  ...
  if (isInteractive && useMesh && enableSlices === false) {
    layerById.mesh = React__default["default"].createElement(Mesh$1$1, {
      key: "mesh",
      points: points,
      width: innerWidth,
      height: innerHeight,
...
var LineCanvas = function LineCanvas(_ref) {
  ...
  var getPointFromMouseEvent = React.useCallback(
    function (event) {
  ...
  var _useTooltip = useTooltip(),
    showTooltipFromEvent = _useTooltip.showTooltipFromEvent,
    hideTooltip = _useTooltip.hideTooltip;
  var handleMouseHover = React.useCallback(
    function (event) {
...
var BlockProgress = function (props) {
  ...
  return React__default["default"].createElement(
    ...
    React__default["default"].createElement(
      ...
      React__default["default"].createElement(
        "div",
        { className: "progress-block__title" },
        title
      ),
      flavour !== "small"
        ? React__default["default"].createElement(
...
var LineProgress = function (_a) {
  ...
  return React__default["default"].createElement(
    ...
    React__default["default"].createElement(
      "div",
      { className: "progress-line__heading" },
      title
    ),
    React__default["default"].createElement(
      "div",
